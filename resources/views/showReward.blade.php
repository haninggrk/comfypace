            ...
            <section class="bg-gray-50 relative w-full h-64 rounded-md"
                ...
                <div class="h-full w-full absolute top-0 left-0 p-8 flex flex-col justify-end">
                    ...
                    <p class="text-gray-100">@if(Auth::user()->role == 2)
                            Your current point is {{Auth::user()->StudentDetail->point}}. Let's turn them into rewards!
                ...
                <ul role="list"
                    ...
                    @foreach ($rewardList as $reward)
                        <li class="relative">
                            ...
                            <p class="block text-sm font-medium text-gray-500 pointer-events-none">Price: {{$reward->price}}
