    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="flex justify-between">
            <h3 class="text-3xl">Student List</h3>
                                        ...
                                        <form action="{{ route('students.store') }}" method="POST">
                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <input type="text" name="nickname" id="last-name"
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <input type="text" name="password" id="email-address"
                                                        autocomplete="email"
                                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                </div>
                                                ...
                                                <div class="col-span-3">
                                                    ...
                                                    <input type="text" name="phone" id="street-address"
                                                ...
                                                <div class="col-span-2">
                                                    ...
                                                    <input type="date" name="birthdate" id="street-address"
                                                        autocomplete="street-address"
                                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                </div>
                                                <div class="col-span-2">
                                                    ...
                                                    <select name="school"
                                                        ...
                                                        @foreach ($schoolList as $school)
                                                            <option value="{{ $school->id }}">{{ $school->school }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-span-2">
                                                    ...
                                                    <input type="text" name="nationality" id="street-address"
                                                        autocomplete="street-address"
                                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                </div>
                                                ...
                                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label for="region"
                                                        ...
                                                        Province</label>
                                                    <input type="text" name="province" id="region"
